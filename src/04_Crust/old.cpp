...
//
// void
// Vu::VuDevice::registerBindlessBDA_Buffer(const VuBuffer& buffer) const {
...
//
// void
// Vu::VuDevice::writeUBO_ToGlobalPool(const VuBuffer& buffer, u32 writeIndex, u32 setIndex) const {
//   vk::DescriptorBufferInfo bufferInfo {.buffer {buffer.buffer}, .offset {0}, .range {sizeof(GPU_FrameConst)}};
//
//   vk::WriteDescriptorSet descriptorWrite {};
...
//
// void
// Vu::VuDevice::registerToBindless(const VuBuffer& buffer, u32 bindlessIndex) const {
...
//
// void
// Vu::VuDevice::registerToBindless(const vk::ImageView& imageView, u32 bindlessIndex) const {
...
//
// void
// Vu::VuDevice::registerToBindless(const vk::Sampler& sampler, u32 bindlessIndex) const {
//   vk::DescriptorImageInfo imageInfo {
//       .sampler = sampler,
//   };
//
...
//
// void
// Vu::VuDevice::initDevice(const VuDeviceCreateInfo& info) {
//
...
//
//   CreateUtils::createDevice(info.requestedFeatures, queueFamilyIndices, physicalDevice, info.deviceExtensions, device,
//                             graphicsQueue, presentQueue);
//   disposeStack.push([&] { vkDestroyDevice(device, nullptr); });
// }
//
// void
// Vu::VuDevice::initCommandPool(const VuDeviceCreateInfo& info) {
...
//
// void
// Vu::VuDevice::initPipelineLayout() {
...
//
// void
// Vu::VuDevice::initBindlessDescriptorSetLayout(const VuDeviceCreateInfo& info) {
...
//
// void
// Vu::VuDevice::initDefaultResources() {
//   stagingBuffer.init(
//       device, vma,
//       {
//           .name           = "stagingBuffer",
...
//
//   debugBufferHnd =
//       createBuffer({.name           = "defaulttBuffer",
//                     .length         = 4096,
//                     .strideInBytes  = 1,
...
//
// void
// Vu::VuDevice::initDescriptorPool(const VuDeviceCreateInfo& info) {
...
//
// void
// Vu::VuDevice::initBindlessDescriptorSet() {
...
//
// vk::CommandBuffer
// Vu::VuDevice::BeginSingleTimeCommands() {
...
//
// void
// Vu::VuDevice::EndSingleTimeCommands(vk::CommandBuffer commandBuffer) {
...
// }
//
// std::expected<Vu::VuDevice, vk::Result>
// Vu::VuDevice::make(const VuDeviceCreateInfo& createInfo) {
//   try {
//     Vu::VuDevice device {createInfo};
//     return device;
//   } catch (vk::Result res) { return std::unexpected {res}; }
// }
//
...
// Vu::VuDevice::createImage(const VuImageCreateInfo& info) {
...
//
// std::shared_ptr<Vu::VuImage>
// Vu::VuDevice::createImageFromAsset(const path& path, vk::Format format) {
//   int   texWidth;
//   int   texHeight;
//   int   texChannels;
//   byte* pixels;
...
// Vu::VuDevice::createSampler(const VuSamplerCreateInfo& info) {
...
// Vu::VuDevice::createBuffer(const VuBufferCreateInfo& info) {
...
// Vu::VuDevice::createShader(path vertexPath, path fragPath, VuRenderPass* vuRenderPass) {
...
// Vu::VuDevice::createMaterialDataIndex() {
...
// Vu::VuDevice::createMaterial(MaterialSettings          matSettings,
...
// Vu::VuDevice::getMaterialData(std::shared_ptr<u32> handle) {
//   VuBuffer* matDataBuffer = materialDataBufferHandle.get();
...
//
// void
// Vu::VuDevice::bindMaterial(vk::CommandBuffer cb, std::shared_ptr<VuMaterial> material) {
...
//
// void
// Vu::VuDevice::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size) {
...
//
// void
// Vu::VuDevice::uploadToImage(const VuImage& vuImage, const byte* data, const vk::DeviceSize size) {
//   // todo
...
//
// void
// Vu::VuDevice::transitionImageLayout(vk::Image image, vk::ImageLayout oldLayout, vk::ImageLayout newLayout) {
//   vk::CommandBuffer commandBuffer = BeginSingleTimeCommands();
//
...
//
// void
// Vu::VuDevice::waitIdle() {
//   device.waitIdle();
//   //vkDeviceWaitIdle(device);
// }
//
// void
// Vu::VuDevice::copyBufferToImage(vk::Buffer buffer, vk::Image image, uint32_t width, uint32_t height) {
//   vk::CommandBuffer commandBuffer = BeginSingleTimeCommands();
//
...
//
// void
// Vu::VuDevice::initBindlessResourceManager(const VuDeviceCreateInfo& info) {
//   bdaBuffer.init(device, vma, {.name = "BDA_Buffer", .length = info.storageBufferCount, .strideInBytes = sizeof(u64)});
//
