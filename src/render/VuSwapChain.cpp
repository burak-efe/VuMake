...
namespace Vu {
    ...
    void VuSwapChain::createSwapChain(VkSurfaceKHR surfaceKHR) {
        ...
        SwapChainSupportDetails swapChainSupport =
                SwapChainSupportDetails::querySwapChainSupport(ctx::vuDevice->physicalDevice, surfaceKHR);
        ...
        //
        {
            ...
            giveDebugName(ctx::vuDevice->device, VK_OBJECT_TYPE_SWAPCHAIN_KHR, swapChain, "Swapcahin");
        }
