...
consteval Architecture
getCurrentArchitecture() {
#if defined(_M_X64) || defined(__x86_64__) ||                                                                          \
    defined(_M_AMD64) // MSVC (64-bit), GCC Clang (64-bit), MSVC (alternative name)
...
inline void
appendTargetVariablePath(std::filesystem::path& path) {
  std::string apnd;
...
inline void
appendTargetVariableExtension(std::filesystem::path& path) {
