...
#include "01_InnerCore/TypeDefs.h" // for u8, u32
...
public:
  ...
  constexpr explicit Color32(u32 v)
  ...
  constexpr void
  setRGBA_uint8(u8 red, u8 green, u8 blue, u8 alpha) {
    r = red;
    g = green;
    b = blue;
    a = alpha;
  ...
  constexpr void
  setRGBA_f(float red, float green, float blue, float alpha) {
