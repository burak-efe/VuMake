...
namespace Vu {
VuSwapChain::VuSwapChain() = default;
VuSwapChain::VuSwapChain(const std::shared_ptr<VuDevice>&             vuDevice,
  ...
  uint32_t queueFamilyIndices[] = {physicalDevice->indices.graphicsFamily, physicalDevice->indices.presentFamily};
...
vk::SurfaceFormatKHR
VuSwapChain::chooseSwapSurfaceFormat(std::span<const vk::SurfaceFormatKHR> availableFormats) {
