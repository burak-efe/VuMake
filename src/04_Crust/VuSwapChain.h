...
// #include "03_Mantle/VuRenderPass.h" // for VuRenderPass
// #include "03_Mantle/VuTypes.h"      // for QueueFamilyIndices
//
// namespace Vu {
//
// struct VuImage;
...
//
//   void
//   beginGBufferPass(vk::CommandBuffer commandBuffer, u32 frameIndex);
//   void
//   beginLightningPass(vk::CommandBuffer commandBuffer, u32 frameIndex);
//
//   void
...
//
//   // static VuQueueFamilyIndices findQueueFamilies(vk::PhysicalDevice device, vk::SurfaceKHR surface);
//
// private:
//   void
//   createSwapChain(vk::SurfaceKHR surfaceKHR);
//
//   void
